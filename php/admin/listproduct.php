                    ...
                    <div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<table id="table_id" class="display">
								...
								<tbody>
									<?php
										$sql = "SELECT * FROM sanpham,loaisanpham WHERE sanpham.IdLoaiSP=loaisanpham.IdLoai";
										...
										if($result->num_rows > 0)
										{
											...
											{?>
												<tr>
													<td><?=$rows['TenSP']?></td>
													<td><img src="Image/<?=$rows['HinhAnh']?>" style="width:50%;"></td>
													<td><?=$rows['SoLuong']?></td>
													...
													<td><a href="editproduct.php?id_product=<?=$rows['Id']?>" class='status bg-blue'><i class="fa fa-edit white"></i></a></td>
